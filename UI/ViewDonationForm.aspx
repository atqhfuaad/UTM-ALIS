<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDonationForm.aspx.cs" Inherits="UTMALIS_ROLLNEY.UI.ViewDonation" %>
...
<body style="background-color: #993333">
    <form id="form1" runat="server">
        ...
        <center style="background-color: #FFCC66">
            <p>
                &nbsp;</p>
            <h2><span class="newStyle2">View Donation Form</span></h2>
            <asp:GridView ID="GridDonation" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" OnSelectedIndexChanged="GridDonation_SelectedIndexChanged" Width="540px" CssClass="newStyle3">
                <Columns>
            ...
            <br />
            <br />
            <asp:Button ID="ButtonDonationForn" runat="server" PostBackUrl="~/UI/DonationForm.aspx" Text="Donation Form" OnClick="ButtonDonationForn_Click" />
                <br />
                <br />
                <br />
                <br />
